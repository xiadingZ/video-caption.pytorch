...
class TopKDecoder(nn.Module):
    ...
    def __init__(self, decoder_rnn, k):
        ...
        self.k = k
        self.hidden_size = self.rnn.dim_hidden
        self.V = self.rnn.dim_output
        self.SOS = self.rnn.sos_id
        self.EOS = self.rnn.eos_id
        self.max_length = self.rnn.max_length

    def forward(self, encoder_hidden=None, encoder_outputs=None, targets=None,
    ...
    def _backtrack(self, nw_output, nw_hidden, predecessors, symbols, scores, b, hidden_size):
        ...
        # Placeholder for lengths of top-k sequences. Similar to `h_n`
